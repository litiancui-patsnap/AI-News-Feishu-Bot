...
OPENAI_FALLBACK_MODEL = os.getenv("OPENAI_FALLBACK_MODEL", OPENAI_CODING_MODEL)
OPENAI_TEMPERATURE = _get_float("OPENAI_TEMPERATURE", 0.2)
OPENAI_MODEL_TOKENS = _get_int("OPENAI_MODEL_TOKENS", 128000)
LLM_RETRY_ATTEMPTS = _get_int("LLM_RETRY_ATTEMPTS", 2)
LLM_RETRY_DELAY_SECONDS = _get_float("LLM_RETRY_DELAY_SECONDS", 3.0)
LLM_OLLAMA_FALLBACK = _get_bool("LLM_OLLAMA_FALLBACK", False)
...
SUMMARY_MIN_CHARS = _get_int("SUMMARY_MIN_CHARS", 30)
